...
SECRET_KEY = 'django-insecure-kxk+x+_nue^#w6ejwef&j_&d2b+t$)6o1o)1om@@xs!(*7nxpf'
...
# Banco: se DB_HOST estiver definido, usa PostgreSQL (RDS em producao, container local).
# Sem DB_HOST, cai no SQLite (conveniencia, ex. um clone rapido sem subir o Postgres).
if os.environ.get("DB_HOST"):
    DATABASES = {
        "default": {
            "ENGINE": os.environ.get("DB_ENGINE", "django.db.backends.postgresql"),
            "NAME": os.environ.get("DB_NAME", "prototipo_db"),
            "USER": os.environ.get("DB_USER", "prototipo"),
